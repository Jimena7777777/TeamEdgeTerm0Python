...
# print(i + " is prime" str(test_prime(i)))
...
user_input2 = input("guess first number:")
if random_number1 == user_input1 and random_number2 == int(user_input2):
...
def response(response):
  print(f"i know youre {responce}, but what am i")
